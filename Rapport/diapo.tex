...
\begin{frame}
	...
	\begin{block}{Les différents prolongements du sujet}
	 \begin{itemize}
	  ...
	  \pause
	  \item Expliquez le problème du logarithme discret et son lien avec Diffie-Hellman.
	  \pause
	...
	\frametitle{TLS-SSL}
	 \begin{block}{Principe}
	  \begin{itemize}
	    ...
	    \pause
	    \item Alice -> Bob ouvrir une communication sécurisée
	    \pause
	    \item Bob -> Alice son certificat, sa clé publique et sa signature
	    \pause
	    \item Alice vérifie que le certificat de Bob est valide
	    \pause
	    \item Alice -> Bob une clé de chiffrement (type Diffie-Hellman)
	    \pause
	    \item Bob déchiffre et l'utilise pour communiquer (Diffie-Hellman)
	    \pause

...
On peut alors réaliser les pas de géants $(g^m)^k$, que l'on stocke dans un tableau associatif avec une clé puis les pas de bébé $yg^{-r}$ jusqu'à obtenir un élément égal à un élément du tableau des pas de géant, cet élément étant une solution du problème de logarithme discret.

...
\maketitle
    ...
    \rput[tl](8,25) %On place le coin sup de boite en (8,25)
    {
    \begin{minipage}{10cm}% A modifier éventuellement
    \LARGE
    Processus de \\
    Lévy et \\
    Bidule
    ...
    \rput[tl](8,20){M\up{r} Person}

    \rput[tl](8,15){\thedate}
    \psset{PointName=none,PointSymbol=none}
    \pstGeonode(18,0){A}
    \pstGeonode(18,29.7){B}
    \psline[linewidth=1.5ex,doubleline=true](B)(A)
    \ncput*[npos=0.65]{étude et environnements}
    \end{pspicture}
    \end{titlepage}
